...
public class LoginController {
    ...
    @PostMapping("/doLogin")
    @ResponseBody
    public RespBean doLogin(@Valid LoginVo payload, HttpServletRequest request, HttpServletResponse response) {
        return userService.doLogin(payload, request, response);
    }
}
